...
facial="C:/Users/pc/Desktop/Accident-Prevention-master/driver.jpg"
...
def main():
    ...
    face="C:/Users/pc/Desktop/Accident-Prevention-master/face.jpg"
    img = ImageTk.PhotoImage(Image.open(face))
    voice="C:/Users/pc/Desktop/Accident-Prevention-master/voice.jpg"
    ...
    face="C:/Users/pc/Desktop/Accident-Prevention-master/yawn.jpg"
    img1 = ImageTk.PhotoImage(Image.open(face))
    panel = Button(window, image = img1,command=fun1)
    panel.image = img1
    panel.place(x=130,y=110)
    voice="C:/Users/pc/Desktop/Accident-Prevention-master/drow.jpg"
    img2 = ImageTk.PhotoImage(Image.open(voice))
    panel2 = Button(window, image = img2,command=fun)
    panel2.image = img2
    panel2.place(x=600,y=110)
    window.mainloop()
